...
ifneq ($(CUSTOM_BUILD),)
include vendor/cesium/config/BoardConfig.mk
endif
...
APEXER := $(HOST_OUT_EXECUTABLES)/apexer$(HOST_EXECUTABLE_SUFFIX)
APICHECK := $(HOST_OUT_JAVA_LIBRARIES)/metalava$(COMMON_JAVA_PACKAGE_SUFFIX)
DEAPEXER := $(HOST_OUT_EXECUTABLES)/deapexer$(HOST_EXECUTABLE_SUFFIX)
...
ZIPALIGN_HOST := $(HOST_OUT_EXECUTABLES)/zipalign$(HOST_EXECUTABLE_SUFFIX)
